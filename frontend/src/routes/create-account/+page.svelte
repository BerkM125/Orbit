        ...
        try {
            ...
            const { data, error: insertError } = await supabase
                ...
                .insert({
                    ...
                    company: company,
                    headshot_image: uploadedHeadshotUrl || `https://www.gravatar.com/avatar/${authStore.user.id}?d=mp&f=y.jpg`,
                    embedding: embedding,
                ...
                <div class="file-upload-area">
                    {#if headshotUrl}
                        <div class="preview-container">
                            ...
                            <button type="button" class="remove-image" onclick={() => { headshotFile = null; headshotUrl = ''; }}>×</button>
                        </div>
                    {/if}
                    <input
                        id="headshot"
